      ...
      >
        ...
        >
          ...
          <span
            class="p-1 font-bold"
            :class="[
              item.id === queryParam.plateId ? 'text-black' : 'text-black'
            ]"
            >{{ item.name }}</span
          >
        </div>
      ...
      <div class="w-full bg-gray-200 pl-1 py-2 ">
        <div class="flex mx-auto text-gray-600 space-x-1">
          <select
            ...
            class="w-24 border-2 border-gray-300 rounded-full focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
          >
          ...
          <input
            ...
            class="w-64 border-2 border-gray-300 bg-white h-8 pl-3 rounded-full text-sm focus:outline-none"
            type="search"
            name="search"
            placeholder="查询帖子标题"
          />
